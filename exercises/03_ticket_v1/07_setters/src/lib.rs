...
impl Ticket {
    pub fn new(title: String, description: String, status: String) -> Ticket {
        Ticket::title_validator(&title);
        Ticket::description_validator(&description);
        Ticket::status_validator(&status);
    ...
    pub fn title_validator(title: &String) {
        if title.is_empty() {
    ...
    pub fn description_validator(desc: &String) {
        if desc.is_empty() {
    ...
    pub fn status_validator(status: &String) {
    ...
    pub fn set_title(&mut self, new_title: String) {
        Ticket::title_validator(&new_title);
        self.title = new_title
    }
    pub fn set_description(&mut self, new_description: String) {
        Ticket::description_validator(&new_description);
        self.description = new_description
    }
    pub fn set_status(&mut self, new_status: String) {
        Ticket::status_validator(&new_status);
